-- This SQL created using SQuirreL SQL Create Table Script.
...
ADD CONSTRAINT FK_M4I3VQOJ6X1291NC0HR19DCEB
FOREIGN KEY (USER_ID)
REFERENCES "PUBLIC"."USERS"(USER_ID)
;
CREATE UNIQUE INDEX SYS_IDX_SYS_PK_10092_10094 ON "PUBLIC"."ACCOUNTS"(ACCOUNT_ID)
;
CREATE INDEX SYS_IDX_10139 ON "PUBLIC"."ACCOUNTS"(USER_ID)
;
